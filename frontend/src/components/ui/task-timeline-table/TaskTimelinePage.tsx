...
export default function TaskTimeLinePage() {
  ...
  return (
    <div className="h-screen w-full overflow-auto">
      <div className="mx-auto grid h-max min-h-full w-max max-w-550 min-w-[1200px] grid-cols-[9rem_1fr] border-2 border-transparent [border-image:linear-gradient(to_top,#4f46e5,#18181b)_1]">
        <aside className="justify-self-start">
          <Navbar />{' '}
        </aside>

        <main className="col-start-2 min-h-full min-w-full px-20 py-1">
